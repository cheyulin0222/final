...
public class PostService {
	...
	public List<Post> findAllByMemberidList(List<Integer> followingList) {
		return pDao.findByMemberList(followingList);
	}
	
	public List<PostDTO> PostListToPostToDTO(Integer memberid, List<Post> oldList) {
	...
	public List<Post> findAllByMemberId(Integer memberid) {
		return pDao.findAllByMemberId(memberid);
	}
}
