<template>
        ...
        <div v-for="(post, key) in posts">
            ...
            <div class="card border-0">
                ...
                <div class="card-header justify-content-between align-items-center">
		            ...
		            <img class="icon" src="../assets/img/icon/more.png" type="button" data-bs-toggle="modal" data-bs-target="#myPostModal" @click="selectPostId(post.postId)"> 
                </div>
    ...
    <MyPostModal @updatePost="onChildClick" />
    <UpdatePostModal :selectedPostId="selectedPostId" ref="child" />
    <DeletePostModal :selectedPostId="selectedPostId"/>
...
<script setup>
    ...
    import MyPostModal from "../components/MyPostModal.vue";
    ...
    const onChildClick = id => child.value.getPostDetail()
